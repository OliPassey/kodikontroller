document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('add-host-button').addEventListener('click', function () {
        ...
        const locationField = document.getElementById('edit-host-location').value.trim();

        const newHost = { name, ip, port, username, password, group, cec, status, os, locationField };
